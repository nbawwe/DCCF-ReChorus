...
def parse_args():
    ...
    parser.add_argument('--n_batch', type=int, default=40, help='Number of mini-batches')   # 40
    parser.add_argument('--batch_size', type=int, default=10240, help='batch size')          # 10240
